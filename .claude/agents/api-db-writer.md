...
## สิ่งที่เอกสารต้องมีเป็นอย่างน้อย

**`db-spec.md`**
- **ER Diagram (บังคับ)**: Mermaid `erDiagram` แสดงทุก entity และความสัมพันธ์ พร้อม cardinality
  (`||--o{` เป็นต้น) — ถ้ามี entity ใดไม่ปรากฏในภาพ ถือว่างานยังไม่เสร็จ
- **ตารางรายละเอียดต่อ entity**: หนึ่งตารางต่อหนึ่ง entity คอลัมน์ `attribute | ความหมาย |
  จำเป็นหรือไม่ | ข้อจำกัด/กฎเชิงธุรกิจ | รหัส FR/NFR ที่เป็นที่มา`
  — อธิบายเป็นชนิดข้อมูลเชิงตรรกะ (ข้อความ / จำนวนเต็ม / วันเวลา / รายการค่าที่กำหนด)
  **ห้ามใช้ SQL type หรือชื่อ engine ใดๆ**
- **กฎความสัมพันธ์**: อธิบายเป็นข้อความว่าความสัมพันธ์แต่ละเส้นหมายถึงอะไรในเชิงธุรกิจ
- **ข้อมูลที่อ่อนไหว**: ทำเครื่องหมาย attribute ที่เป็นข้อมูลสุขภาพหรือข้อมูลส่วนบุคคล
  พร้อมอ้างอิง NFR ด้านความปลอดภัย/ความเป็นส่วนตัวที่เกี่ยวข้อง

**`api-spec.md`**
- **ตาราง operation**: `ชื่อ operation | ทำอะไร | input | output | ข้อผิดพลาดที่เป็นไปได้ |
  component เจ้าของ | รหัส FR` — **ห้ามระบุ HTTP method หรือ path**
- **ความสอดคล้องกับ db-spec**: ทุก field ใน input/output ต้องสืบย้อนไปหา attribute ใน `db-spec.md` ได้
- **Operation ↔ journey**: ตารางว่าแต่ละขั้นตอนใน `user-journey.md` เรียก operation ใดบ้าง
...
## กฎสำคัญ
- `db-spec.md` ต้องมี Mermaid `erDiagram` ที่ครอบคลุมทุก entity เสมอ และทุก entity ต้องมีตารางรายละเอียด attribute ของตัวเอง
