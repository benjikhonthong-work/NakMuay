...
- **Data flow ต่อ user journey**: ทุก journey ใน `user-journey.md` ต้องมี data flow diagram
  (Mermaid `flowchart`) อย่างน้อยหนึ่งภาพ แสดงว่าข้อมูลวิ่งผ่าน component ใดบ้างตามลำดับ
  ตั้งแต่จุดที่ผู้ใช้ป้อนเข้ามาจนถึงผลลัพธ์ที่แสดงกลับ พร้อมกำกับรหัส FR บนเส้นหรือ node
- **Component inventory**: ตารางรายการ component เชิง logical พร้อมหน้าที่ ข้อมูลที่ถือครอง
  และ component อื่นที่คุยด้วย
- **Boundary ของระบบ**: ระบุชัดว่าอะไรอยู่ในระบบ อะไรเป็นระบบภายนอก และข้อมูลข้ามเส้นตรงไหน
- **NFR mapping**: ตาราง NFR แต่ละตัว ↔ component ที่รับผิดชอบ ↔ วิธีที่การออกแบบรองรับข้อนั้น
- **จุดที่ยังไม่ตัดสินใจ**: ตารางรายการการตัดสินใจที่รอ `technology-stack.md` พร้อมผลกระทบถ้าเลือกต่างกัน
...
## กฎสำคัญ
- ทุก journey ใน `user-journey.md` ต้องมี data flow diagram กำกับอย่างน้อยหนึ่งภาพ ห้ามข้าม journey ใด
