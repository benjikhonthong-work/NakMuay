...
ทุกคำถามที่ subagent ถามผู้ใช้ระหว่างงานนี้ ต้องมี **อย่างน้อย 3 แนวทางให้เลือก** ทุกแนวทางระบุ
**ข้อดีและข้อเสีย** และมี **แนวทางที่แนะนำ 1 ข้อ** วางเป็นตัวเลือกแรกพร้อมต่อท้าย label ด้วย
"(แนะนำ)" และเหตุผลที่อ้างอิงบริบทจริงของโปรเจกต์ — ถ้าผลลัพธ์ที่ได้กลับมาแสดงว่า subagent
ถามโดยไม่มีตัวเลือกครบหรือไม่มีข้อเสนอแนะ ให้ถือว่าผิดกฎ แจ้งผู้ใช้และให้ถามใหม่

**ห้ามตอบแทนผู้ใช้ในเรื่องที่เป็นการตัดสินใจเชิงออกแบบ** ไม่ว่าจะดูชัดเจนแค่ไหน

## ข้อควรระวัง

- `db-spec.md` ต้องมี Mermaid `erDiagram` ครบทุก entity และแต่ละ entity ต้องมีตารางรายละเอียด attribute — ตรวจข้อนี้เองก่อนรายงานผู้ใช้เสมอ
